...
public static class TurtleMath
{
    ...
    /// </summary>
    /// <param name="vec2">
    ///     The vector to calculate the angle of.
    /// </param>
    /// <returns>
    ...
    /// <returns>
    ///     The angle between the two specified vectors.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     The vector with the specified angle and length.
    /// </returns>
    ...
    /// </summary>
    /// <param name="vec2">
    ///     The vector to get the perpendicular of.
    /// </param>
    /// <returns>
    ///     A vector that is perpendicular to the given vector.
    /// </returns>
